...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            8145000, -2835000, -187500, -2112500, 7975000, -745000, -1640000, -5787500, 12552500
        },
        {  // i4P10[9]
            1619020, -1601802, -27040, 85925, -746456, 660614, 371911, 1138678, -1507288
        },
        {  // i4P01[9]
            45855, -514964, 468725, -88692, 348540, -269368, -210825, -1380691, 1588471
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    224,    // PCloudyRightBound
                    49,    // PCloudyLeftBound
                    -122,    // PCloudyUpperBound
                    -320    // PCloudyLowerBound
                },
                // Shade
                {
                    324,    // PShadeRightBound
                    49,    // PShadeLeftBound
                    -122,    // PShadeUpperBound
