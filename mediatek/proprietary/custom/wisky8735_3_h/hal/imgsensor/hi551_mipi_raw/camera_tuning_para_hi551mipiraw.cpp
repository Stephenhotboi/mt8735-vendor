...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            6750000, -1305000, -325000, -1825000, 9555000, -2617500, -1652500, -3305000, 10077500
        },
        {  // i4P10[9]
            2357066, -3297356, 917896, -605255, -439577, 1040856, -164476, 2015478, -1873395
        },
        {  // i4P01[9]
            1624696, -2167416, 528766, -662619, -946167, 1605611, -398045, 680219, -296128
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    ...
                    85,    // PCloudyLeftBound
                    -213,    // PCloudyUpperBound
                    -337    // PCloudyLowerBound
                },
                // Shade
                {
                    360,    // PShadeRightBound
                    85,    // PShadeLeftBound
                    -213,    // PShadeUpperBound
                    -337    // PShadeLowerBound
                },
                // Twilight
                {
                    -36,    // PTwiRightBound
                ...
                // Warm fluorescent
                {
                    -170,    // PWFluoRightBound
                    -370,    // PWFluoLeftBound
                    -223,    // PWFluoUpperBound
            ...
            // CCT estimation
            {
                ...
                {
                -466,    // i4RotatedXCoordinate[0]
                -375,    // i4RotatedXCoordinate[1]
                -231,    // i4RotatedXCoordinate[2]
