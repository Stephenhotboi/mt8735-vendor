...
#include "camera_AE_PLineTable_gc2755submipi_raw.h"
#include "camera_info_gc2755submipi_raw.h"
...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        862,      // i4B_MIN
        {  // i4P00[9]
            10670000, -4480000, -1077500, -1755000, 7847500, -972500, -335000, -4135000, 9580000
        },
        {  // i4P10[9]
            2308994, -2533578, 224526, -322357, 38686, 288412, 142209, 855938, -998148
        },
        {  // i4P01[9]
            1451210, -1472441, 16484, -584329, -240345, 823903, -36559, -52502, 89061
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Warm fluorescent
                {
                    ...
                    -376,    // PWFluoLeftBound
                    -324,    // PWFluoUpperBound
                    -540    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -176,    // PIncaRightBound
