...
public class UartUsbSwitch extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBar actionBar = getActionBar();			// add 2016
        if (actionBar != null) {
        	actionBar.setDisplayHomeAsUpEnabled(true);	// add 2016
        	actionBar.setHomeButtonEnabled(true);		// add 2016
        }
    }
 
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {		// add 2016
