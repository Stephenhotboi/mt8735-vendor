...
#elif defined(HD720) || defined(CU_HD720) || defined(CMCC_HD720) || defined(CT_HD720) || defined(CMCC_LTE_HD720) || defined(CT_LTE_HD720) || defined(CU_LTE_HD720) || defined(Y50BPRO_DEV) || defined(Y128A_DEV) || defined(R150A_DEV)
	// hd720 720*1280
#ifndef HD720_RATATION90
	// battery capacity rectangle
	#define CAPACITY_LEFT                (276) // battery capacity center
...
// battery capacity rectangle
#define CAPACITY_LEFT				 (185) // battery capacity center
#define CAPACITY_TOP				 (558)
#define CAPACITY_RIGHT				 (CAPACITY_LEFT + 261)
#define CAPACITY_BOTTOM 			 (CAPACITY_TOP + 163)

// first number rectangle
#define NUMBER_LEFT 				 (510) // number
#define NUMBER_TOP					 (570)
#define NUMBER_RIGHT				 (NUMBER_LEFT + 64)
#define NUMBER_BOTTOM				 (NUMBER_TOP + 45)

// %  rectangle
#define PERCENT_LEFT				 (NUMBER_LEFT) // percent number_left + 2*number_width
#define PERCENT_TOP 				 (NUMBER_BOTTOM + 45)
#define PERCENT_RIGHT				 (PERCENT_LEFT + 64)
#define PERCENT_BOTTOM				 (PERCENT_TOP + 60)

// top animation part
#define TOP_ANIMATION_LEFT			 (300) // top animation
#define TOP_ANIMATION_TOP			 (CAPACITY_TOP)
#define TOP_ANIMATION_RIGHT 		 (329)
#define TOP_ANIMATION_BOTTOM		 (CAPACITY_BOTTOM)
